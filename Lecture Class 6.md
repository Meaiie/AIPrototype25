...
### 1. Web page
> เป็น web ที่เราเอาข้อมูลของเราใส่เข้าไป เพื่อให้คนอื่นเข้ามาดูข้อมูลของเรา<br>
> ภาษาที่ใช้ :<br>
>   - HTML → Hypertext Markup Language<br>
>   - CSS(ช่วย HTML ในการจัดหน้าให้สวยงาม)<br>
>   - javascript (ควบคุมการทำงาน การกดปุ่มของเครื่อง) → ทำให้มีฟังชันก์มากขึ้น ex. ปุ่มกด ,กดบวกเลขได้<br>


### 2. Web application
> เหมือนหน้าเว็บไซต์ทั่วไป แต่มีฟังก์ชั่นการทำงานให้ใช้งานได้
> ภาษาที่ใช้ :<br>
  > - HTML<br>
  > - CSS(ช่วย HTML ในการจัดหน้าให้สวยงาม)<br>
  > - javascript (ควบคุมการทำงาน การกดปุ่มของเครื่อง) + Server side script (ใช้ในการคิดคำนวณผลลัพทธ์)<br>
  > Server side script เช่น Python (Flask package) : ทำให้ user run บน com ที่ไม่ต้องแรงมากได้เพราะมัน run บน server และทำให้ code ของ dev ไม่หลุดไปไหน<br>

### 3. Web service (api)
> ใช้แค่ Server side script Python (Flask package) เพราะไม่ได้ต้องการให้คนมาใข้ <br>
Api เป็นตัวกลางที่ช่วยเชื่อมให้แต่ละเว็บคุยกัน<br>
เซ็ท password ได้ , set ip เครื่องที่สามารถเรียกใช้ได้จาก backend<br>
